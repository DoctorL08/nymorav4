...
public enum PassiveType
{
    ...
    // ── Nymora ──────────────────────────────────────────────────────────
    PresenceFuneste,    // Ghostra    : jauge dorsale, bonus fixe +35/+55/+75 par sort dans le dos
    VolDAme,            // Soulrender : jauge dégâts (+1/60 dmg), bonus % croissant, débloque Âme Lacérée
    Toxine,             // Necram     : jauge marques venin, ticks DoT croissants (22→25→29), débloque Virus Fatal
    Custom,
}
